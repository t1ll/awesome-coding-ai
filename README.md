...
| [Augment](https://www.augmentcode.com/) | cli | | [30,000-credit trial (card required)](https://www.augmentcode.com/blog/augment-codes-pricing-is-changing) |
...
| [Claude Code](https://www.claude.com/product/claude-code) | own-model, cli, background | Built by Anthropic | [50% more weekly usage for eligible plans through Aug 19](https://support.claude.com/en/articles/15910845-claude-code-may-august-2026-weekly-limits-promotion) |
...
| [CodeBuddy](https://www.codebuddy.ai/) | ide | Built by Tencent | [Pro $9.95/mo (was $19.90)](https://www.codebuddy.ai/docs/ide/Account/pricing) |
...
| [GitHub Copilot](https://github.com/features/copilot) | | | [Existing Business/Enterprise customers get higher included credits through Sep 1](https://docs.github.com/en/copilot/concepts/billing/usage-based-billing-for-organizations-and-enterprises) |
...
| [IBM Bob](https://www.ibm.com/products/bob) | ide | Built by IBM | [30-day trial with 40 Bobcoins](https://bob.ibm.com/trial) |
...
| [Junie](https://www.jetbrains.com/junie/) | extension | Built by JetBrains | [30-day JetBrains AI Pro trial](https://junie.jetbrains.com/docs/junie-ide-plugin.html) |
| [Kilo Code](https://kilo.ai/) | oss | | [Laguna S 2.1 and Hy3 currently free](https://kilo.ai/landing/free-models) |
| [Kimchi](https://kimchi.dev/) | cli, oss | Coding platform for open-source models | |
...
| [Kiro CLI](https://kiro.dev/) | cli | Built by Amazon Web Services | [Eligible AWS startups: complimentary Pro+ and 1 year of promo credits; apply by Jul 31](https://kiro.dev/startups/terms/) |
...
| [Ona](https://ona.com/) | background | Formerly Gitpod | [Up to $200/mo for approved OSS maintainers and contributors](https://ona.com/open-source) |
| [OpenClaw](https://openclaw.ai/) | oss | Personal agent that also codes | |
| [OpenCode](https://opencode.ai/) | cli, oss | | [6 Zen models free for a limited time](https://opencode.ai/docs/zen/) |
...
| [OpenHands](https://www.openhands.dev/) | background, oss | | |
...
| [Podium](https://podium.do/) | gui, oss | Agents manage shared issues, dependencies, and delegation through conversation | |
...
| [Rovo Dev](https://www.atlassian.com/software/rovo-dev) | cli | | [30-day Standard upgrade trial with 2,000 credits/mo](https://support.atlassian.com/subscriptions-and-billing/docs/how-billing-works-for-rovo-dev-standard/) |
...
| [ZCode](https://zcode.z.ai/en) | gui | Desktop coding agent optimized for GLM | [~1.5x GLM quota for Coding Plan subscribers through Jul 31; 5-day first-user trial](https://zcode.z.ai/en/docs/welcome) |
